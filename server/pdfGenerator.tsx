...
const AuditDocument = ({ data }: { data: ReportData }) => {
    ...
    return (
        <Document>
            ...
            {/* Analysis Sections Generated by LLM */}
            <Page size="A4" style={styles.page} wrap>
                ...
                <Text style={[styles.subHeader, { marginTop: 10 }]}>Scenario A: Status Quo</Text>
                <View>{renderParagraphs(analysis.scenarioA)}</View>

                <Text style={[styles.subHeader, { marginTop: 20 }]}>Scenario B: Rationalisation</Text>
                <View>{renderParagraphs(analysis.scenarioB)}</View>
