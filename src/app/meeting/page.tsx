  ...
  return (
    <div className="flex-1 p-4 md:p-6 lg:p-8 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Decisions scheduled for the current meeting.</p>
      </div>

      <div className="space-y-4">
        {scheduledDecisions.length > 0 ? (
          scheduledDecisions.map(decision => (
            <AgendaItem key={decision.id} decision={decision} />
          ))
        ) : (
      ...
      <div>
        ...
        <p className="text-muted-foreground">Outcomes from previous meetings.</p>
      </div>
